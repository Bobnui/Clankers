...
if isStretching
{
	draw_sprite_ext(S_Player_Torso, 1, x, GetTopOfHead(), image_xscale, 1, 0, c_white, 1);
}
else if isRetracting
{
	draw_sprite_ext(S_Player_Torso, 2, x, GetTopOfHead(), image_xscale, 1, 0, c_white, 1);
}
else if isGrounded
{
	draw_sprite_ext(S_Player_Torso, 0, x, GetTopOfHead(), image_xscale, 1, 0, c_white, 1);
}
else if isHanging
{
	draw_sprite_ext(S_Player_Hanging, walkFrame, x, GetTopOfHead(), image_xscale, 1, 0, c_white, 1);
}
else 
{
	draw_sprite_ext(S_Player_Torso, , x, GetTopOfHead(), image_xscale, 1, 0, c_white, 1);
}
