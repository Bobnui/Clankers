...
if hanging == false
{
	draw_sprite_ext(s_Robot_Torso, torso_sprite, x, y - rise_amount - lowering_amount, image_xscale, 1, 0, c_white, 1);
}
else
{
...
{
	draw_sprite_ext(s_Robot_Middle_Bit, 0, x, y - 5, image_xscale, rise_amount + lowering_amount, 0, c_white, 1);
}
